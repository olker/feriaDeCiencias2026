...
<div class="max-w-7xl mx-auto px-4 py-6">
    ...
    <div class="mb-6">
        ...
        <p class="mt-1 text-slate-600">
            Seleccione qué grupo será evaluado por cada docente.
        </p>
    </div>
    ...
    <div class="mb-8 rounded-xl bg-white p-6 shadow">
        ...
        <form
            action="{{ route('docentes.evaluadores.store') }}"
            method="POST"
        >
            @csrf
            ...
            <div class="grid grid-cols-1 gap-5 md:grid-cols-2">
                ...
                <div>
                    ...
                    <select
                        name="docente_id"
                        id="docente_id"
                        class="w-full rounded-lg border px-3 py-2 {{ $errors->has('docente_id') ? 'border-red-500' : 'border-slate-300' }}"
                    >
                        <option value="">
                ...
                <div>
                    ...
                    <select
                        name="grupo_id"
                        id="grupo_id"
                        class="w-full rounded-lg border px-3 py-2 {{ $errors->has('grupo_id') ? 'border-red-500' : 'border-slate-300' }}"
                    >
                        <option value="">
                            Seleccione un grupo
                        </option>
                ...
                <tbody class="divide-y divide-slate-200">
                    ...
                    @forelse($asignaciones as $asignacion)
                        ...
                        <tr class="hover:bg-slate-50">
                            ...
                            <td class="px-6 py-4">
                                {{ $asignacion->grupo?->curso?->nombre ?? 'Sin curso' }}
                            </td>
                            ...
                            <td class="px-6 py-4 text-center">
                                ...
                                <form
                                    action="{{ route('docentes.evaluadores.destroy', $asignacion->id) }}"
                                    method="POST"
                                    class="inline"
